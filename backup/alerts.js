...
<body style="margin: 0; padding: 0; background-color: #f5f5f5; font-family: Arial, Helvetica, sans-serif;">
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f5f5f5;">
        <tr>
            ...
            // Your template uses "user_email" for To Email and "user_name" for From Name
            // IMPORTANT: Make sure your EmailJS template "To Email" field contains exactly: {{user_email}}
            const templateParams = {
                user_email: cleanEmail,            // For "To Email" field - must match template variable
                user_name: userName,                // For "From Name" field
                to_name: userName,                  // For display in content ({{to_name}})
                name: userName,                     // For message content ({{name}})
                email: cleanEmail,                  // For "Reply To" field ({{email}})
                ...
                message_html: htmlMessage,          // Alternative HTML field (some templates use this)
                message_text: plainMessage,         // Plain text fallback
                time: timeString                    // For time display in content ({{time}})
            };
...
// How Alerts Work Cards Auto-Hover Animation - All Cards Together (Optimized)
document.addEventListener('DOMContentLoaded', function() {
